...
public:
    ...
    static void setTextureAlphaMod(SDL_Texture* texture, Uint8 alpha);
    static SDL_Texture* setTextureBlendMod(SDL_Texture* texture, SDL_BlendMode blendMode = SDL_BLENDMODE_BLEND);
